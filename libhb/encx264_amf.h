...
#ifndef HB_ENCX264_AMF_H
#define HB_ENCX264_AMF_H
...
static const char * const hb_x264_amf_encopt_synonyms[][2] =
{
...
void               hb_x264_amf_global_init(void);
const x264_amf_api_t * hb_x264_amf_api_get(int bit_depth);

#endif // HB_ENCX264_AMF_H
